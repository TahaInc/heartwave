...
| When a logged session is selected, its summary is displayed alongside the ability to delete it | 7,8 | MainWindow, Session | Open the 'Log/History' menu and view the UI. | When a session is selected, its statistics are displayed and the left arrow key will delete it. |
